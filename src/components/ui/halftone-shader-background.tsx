...
const PALETTE = ["#02010A", "#04052E", "#3D2C8D", "#916BBF"].map(hexToRgb01);
...
export default function HalftoneShaderBackground() {
  ...
  useEffect(() => {
    ...
    function render(now: number) {
      ...
      gl.uniform4f(uShape, 1.1, 0.29, 0.5, 0.0);
      gl.uniform4f(uSurface, 2.4, 1.18, 0.0, 1.0);
      gl.uniform4f(uFinish, 0.0, 0.0, 0.0, 0.06);
      gl.uniform4f(uTransform, 3420.0, 0.0, 0.0, 0.0);
